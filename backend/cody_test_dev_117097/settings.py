"""
Django settings for cody_test_dev_117097 project.
...
ROOT_URLCONF = 'cody_test_dev_117097.urls'
...
WSGI_APPLICATION = 'cody_test_dev_117097.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cody_test_dev_117097 API",
    "DESCRIPTION": "API documentation for cody_test_dev_117097 App",
    "VERSION": "v1",
}
